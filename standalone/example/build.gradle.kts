...
repositories {
    ...
    maven("https://repo.poyfrost.org/releases")
}
...
dependencies {
    ...
    implementation("org.polyfrost:universalcraft-standalone:$universalCraftVersion")
...
application {
    mainClass.set("org.polyfrost.example.MainKt")
}
...
tasks.shadowJar {
    ...
    minimize {
        ...
        exclude(dependency("org.polyfrost:universalcraft-standalone:.*")) // https://github.com/GradleUp/shadow/issues/522
...
configurations.all {
    resolutionStrategy.dependencySubstitution {
        substitute(module("org.polyfrost:universalcraft-standalone")).using(project(":standalone"))
    }
}
